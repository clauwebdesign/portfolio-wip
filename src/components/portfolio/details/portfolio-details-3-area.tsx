    ...
    <div className="showcase-details-2-area pb-50">
        <div className="container">
          <div className="row tp-brand-brd-top pt-50">
              <div className="col-xl-8">
                <div className="showcase-details-2-section-box">
                    <h4 className="project-details-1-title tp-char-animation">Understanding the Problem</h4>
                </div>
              </div>
          </div>
          <div className="row">
    ...
    <div className="showcase-details-2-area">
        <div className="container">
          ...
          <div className="row">
              ...
              <div className="col-xl-9">
                <div className="showcase-details-2-content-right tp_title_anim">
                    <p className="pb-25">A comprehensive web platform that allows users to register, explore available opportunities, make reservations, complete secure payments, and manage their bookings through an intuitive and interactive dashboard. The platform also will include dedicated tools for administrators, enabling them to manage users and reservations, export data, and access detailed statistics. </p>
                </div>
              </div>
          </div>
        </div>
    ...
    <div className="showcase-details-2-area">
        <div className="container">
          ...
          <div className="row">
              ...
              <div className="col-xl-9">
                <div className="showcase-details-2-content-right tp_title_anim">
                    <p className="pb-25">I created low-fidelity wireframes that went through multiple rounds of client review, helping to identify improvements early in the process. This approach streamlined the design workflow, saving time during prototyping and ensuring alignment with client expectations before moving into visual design.</p>
                </div>
              </div>
          </div>
        </div>
    ...
    <div className="showcase-details-2-area pb-120">
        <div className="container">
          ...
          <div className="row">
              ...
              <div className="col-xl-9">
                <div className="showcase-details-2-content-right tp_title_anim">
                    <p className="pb-25">The AWAQ Campus Internship homepage was designed to clearly share the program’s mission, attract users, and encourage internship reservations. It followed ACI’s branding while using a fresh, modern look. Illustrations from Storyset (Freepik), recommended in the brand guide, helped make the content more engaging. Key sections the client wanted to highlight were given special attention. Clear visuals and layout showed the benefits of joining, with strong calls to action throughout. The design also included Awaq’s new ECOSOC Special Advisory Status to build trust and inspire users to take part.</p>
                </div>
              </div>
          </div>
        </div>
